...
-- -----------------------------------------------------
-- Schema concessionaria2122m
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema concessionaria2122m
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `concessionaria2122m` DEFAULT CHARACTER SET utf8 ;
USE `concessionaria2122m` ;

-- -----------------------------------------------------
-- Table `concessionaria2122m`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122m`.`cliente` (
...
-- -----------------------------------------------------
-- Table `concessionaria2122m`.`funcionario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122m`.`funcionario` (
...
-- -----------------------------------------------------
-- Table `concessionaria2122m`.`marca`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122m`.`marca` (
...
-- -----------------------------------------------------
-- Table `concessionaria2122m`.`modelo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122m`.`modelo` (
  ...
  CONSTRAINT `fk_modelo_marca`
    ...
    REFERENCES `concessionaria2122m`.`marca` (`id_marca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `concessionaria2122m`.`venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `concessionaria2122m`.`venda` (
  ...
  CONSTRAINT `fk_venda_cliente1`
    ...
    REFERENCES `concessionaria2122m`.`cliente` (`id_cliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_funcionario1`
    FOREIGN KEY (`funcionario_id_funcionario`)
    REFERENCES `concessionaria2122m`.`funcionario` (`id_funcionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_venda_modelo1`
    FOREIGN KEY (`modelo_id_modelo`)
    REFERENCES `concessionaria2122m`.`modelo` (`id_modelo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
